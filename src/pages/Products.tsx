...
import PressurePulleyImg from "../assets/Pressure_Pulley.png";
import bearingPulleyImg from "../assets/Bearing_Pulley.png";
...
export default function Products() {
  ...
  const products = [
    {
      title: "Bearing Pulley",
      spec: "High-RPM Sealed Integration",
      image: bearingPulleyImg,
      points: [
        "Precision-bored concentricity tolerances for zero harmonic runout.",
        "Engineered for ultra-low kinetic friction under sustained operational velocity.",
        "Integrated multi-stage load shielding for extended mechanical longevity."
      ]
    },
    {
      title: "Jockey Pulley",
